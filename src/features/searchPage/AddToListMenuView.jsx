...
const AddToListMenuView = (props) => {
    const createNewList = () => {
      ...
      <li className="createNewList">   
        <form onSubmit={props.addNewMovieList}>
          <input autoFocus type="text" id="newListName" value={props.newListName} onChange={props.editListName}/>
    ...
    <div className="addToListMenuBackground">
      <div className="addToListMenu">
        ...
        <li className="setCreateListButton" onClick={() => props.setShowCreateNewList(prevstate => !prevstate)}>Create list</li>
